...
class _DashboardMagasinPageState extends State<DashboardMagasinPage> {
  ...
  void initState() {
    ...
    print('🚀 Dashboard init - Magasin: ${widget.magasinId}');
        ...
        builder: (context, snapshot) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      setState(() {
                        futureProduits = ProduitService.getProduits(
                            widget.magasinId,
                            widget.token
                        );
                      });
          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  _buildDashboard(produits),
                  const SizedBox(height: 20),
                  _buildBoutonArticles(),
                  SizedBox(height: 20),
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text("Produits trouvés: ${produits.length}",
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      ],
                    ),
                  ),
                  SizedBox(height: 12),
                  ...produits.take(3).map((p) => Card(
                    child: ListTile(
                      leading: CircleAvatar(
                        child: Text("${p.quantiteActuelle}"),
                        backgroundColor: Colors.green,
                      ),
                      title: Text(p.designation, style: TextStyle(fontWeight: FontWeight.w600)),
                      subtitle: Text("Ref: ${p.reference} | Qte: ${p.quantiteActuelle}"),
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        icon: Container(
          ...
          child: Icon(Icons.list_alt, color: Colors.white, size: 22),
        ),
        label: Text(
          "Voir tous les articles",  // ✅ CORRIGÉ - plus de produits.length
          style: TextStyle(
            color: Colors.white,
            fontSize: 16,
